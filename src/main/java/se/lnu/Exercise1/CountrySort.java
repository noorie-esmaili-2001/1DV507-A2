...
public class CountrySort {
    private static final String[] COUNTRIES = {"Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola",
    ...
    public static void main(String[] args) {
        ...
        Comparator<String> reverseAlphabetic = Comparator.reverseOrder(); // Must be updated
